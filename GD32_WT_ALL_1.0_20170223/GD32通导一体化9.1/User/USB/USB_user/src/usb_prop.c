...
ONE_DESCRIPTOR String_Descriptor[5] =
{
    ...
    {(uint8_t*)CustomHID_StringSerial, CUSTOMHID_SIZ_STRING_SERIAL},
		{(uint8_t*)MASS_StringInterface, 16}
};
...
void CustomHID_Reset(void)
{
  ...
  OTG_DEV_EP_Init(EP2_OUT, OTG_DEV_EP_TYPE_INT, REPORT_COUNT);
#else 
...
{
  return NULL;//Standard_GetDescriptorData(Length, &CustomHID_Report_Descriptor);
}
